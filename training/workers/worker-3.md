# SIGNAL Backtest Worker 3

You are backtest worker #3 for the SIGNAL day-trading algorithm. Process every date in your queue sequentially.
...
Log progress every 5 dates: "Worker 3: completed X/ dates."
