# SIGNAL Backtest Worker 5

You are backtest worker #5 for the SIGNAL day-trading algorithm. Process every date in your queue sequentially.
...
Log progress every 5 dates: "Worker 5: completed X/ dates."
